...
export const SUB_SERVICE_CONTENT: Record<string, SubServiceContent> = {
  "blocked-toilet": {
    ...
    relatedLinks: [
      ...
      { text: "Drain unblocking in Bournemouth", href: "/locations/bournemouth/drain-unblocking/" }
    ]
  },
  ...
  "blocked-bath": {
    ...
    pricingGuide:
      "Bath and shower drain unblocking in the Bournemouth area typically costs between £80 and £140. Shower trays with restricted access or blockages located further downstream may require additional work and cost slightly more. We always confirm the price before starting. No call-out fee applies.",
    faqs: [
  ...
  "external-drain-unblocking": {
    ...
    faqs: [
      ...
      { question: "Can tree roots cause external drain blockages?", answer: "Tree roots are one of the most common causes of external drain blockages in Bournemouth. Roots seek out moisture and can penetrate pipe joints and cracks, growing inside the pipe until they obstruct flow. Regular CCTV inspections help detect root ingress early before it causes a complete blockage." },
  ...
  "commercial-jetting": {
    ...
    relatedLinks: [
      ...
      { text: "Blocked drains in Bournemouth", href: "/locations/bournemouth/blocked-drains/" }
    ]
  },
