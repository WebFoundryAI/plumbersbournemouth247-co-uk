...
export const SUB_SERVICE_CONTENT: Record<string, SubServiceContent> = {
  "blocked-toilet": {
    ...
    relatedLinks: [
      ...
      { text: "Drain unblocking in Manchester", href: "/locations/glasgow/drain-unblocking/" }
    ]
  },
  ...
  "blocked-bath": {
    ...
    relatedLinks: [
      ...
      { text: "Drain unblocking in Stockport", href: "/locations/east-kilbride/drain-unblocking/" }
    ]
  },
  ...
  "commercial-jetting": {
    ...
    relatedLinks: [
      ...
      { text: "Blocked drains in Manchester", href: "/locations/glasgow/blocked-drains/" }
    ]
  },
