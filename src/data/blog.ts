...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    metaDescription: "Learn the early warning signs of a blocked drain in Bournemouth. From slow drainage to bad smells, know when to call a professional before it becomes an emergency.",
    excerpt: "Catching a blocked drain early can save you hundreds of pounds in emergency repairs. Here are the key warning signs every Bournemouth homeowner should know.",
...
If you're experiencing a complete blockage, our [blocked drain specialists](/services/blocked-drains/) are available 24/7 across [Bournemouth](/locations/bournemouth/) and surrounding areas. For urgent situations, our [emergency drain service](/services/emergency-drain-services/) guarantees a rapid response.

Call us on ${BRAND.phoneFormatted} for a no-obligation quote, or [contact us online](/contact/) to book an appointment.`,
    author: "Plumbers Bournemouth 247",
  ...
  },
  {
    ...
    metaTitle: "Prevent Kitchen Drain Blockages | Bournemouth Tips",
    metaDescription: "Stop kitchen drain blockages before they start. Expert tips on preventing grease buildup, food waste disposal, and maintaining clear drains in your Bournemouth home.",
    ...
    content: `Kitchen drains handle more abuse than any other drain in your home. Between cooking oils, food scraps, soap residue, and everything else that goes down the sink, it's no wonder they're the most frequently blocked drains we see in Bournemouth homes.
...
Contact ${BRAND.brandName} on ${BRAND.phoneFormatted} for expert advice and assistance, or [get in touch online](/contact/).`,
  ...
  },
  {
    ...
    metaTitle: "CCTV Drain Survey Before Buying | Bournemouth Guide",
    metaDescription: "Buying a house in Bournemouth? Discover why a pre-purchase CCTV drain survey could save you thousands and give you negotiating power.",
...
Many of our Bournemouth customers have negotiated thousands off their purchase price after our surveys revealed drain problems the seller wasn't aware of.
...
At ${BRAND.brandName}, we provide comprehensive [pre-purchase drain surveys](/services/cctv-drain-surveys/pre-purchase-survey/) across [Bournemouth](/locations/bournemouth/) and Bournemouth and surrounding areas. Our engineers explain exactly what they find and provide honest advice about any issues.
...
Book your [CCTV drain survey](/services/cctv-drain-surveys/) today by calling ${BRAND.phoneFormatted} or [contact us online](/contact/).`,
  ...
  },
  {
    ...
    metaDescription: "Experiencing a drain emergency in Bournemouth? Learn what to do immediately to minimise damage while waiting for professional help to arrive.",
...
We aim to arrive within 1-2 hours for [emergency callouts across Bournemouth](/locations/bournemouth/emergency-drain-services/) and Bournemouth and surrounding areas. Our [emergency drain services](/services/emergency-drain-services/) team is available 24 hours a day, 7 days a week.
...
Call us immediately on ${BRAND.phoneFormatted} if you're experiencing a drain emergency, or [request urgent help online](/contact/).`,
  ...
  },
  {
    ...
    metaTitle: "Drain Jetting vs Rods | Bournemouth Comparison",
    metaDescription: "Should you use drain rods or high-pressure jetting to clear a blockage? Our Bournemouth drainage experts explain when each method works best.",
...
When you call us for a blocked drain in Bournemouth, we typically:
...
For reliable [drain clearing across Bournemouth](/locations/bournemouth/drain-jetting/), call ${BRAND.brandName} on ${BRAND.phoneFormatted} or [request a quote online](/contact/). We also cover [Poole](/locations/poole/), [Christchurch](/locations/christchurch/), and [Wimborne](/locations/wimborne/).`,
    author: "Plumbers Bournemouth 247",
